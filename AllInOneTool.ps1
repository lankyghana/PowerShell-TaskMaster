# Lanky Tools Box - PowerShell Automation, Security, Network, and File Copier Tool
...
function Show-Welcome {
    ...
    Write-Host "         Welcome to Lanky Tools Box!" -ForegroundColor Green
...
function Show-WiFiProfiles {
    ...
    foreach ($profile in $profiles) {
        ...
        $line = "[$index] Profile: $profile`n    Password: $password"
        Write-Host $line
        $wifiInfo += $line
        $index++
    }
